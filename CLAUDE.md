...
- **Cupom só para novos clientes** — capture e confirm verificam se o email já pertence a um cliente com pedidos (Bling + NuvemShop). Se sim, bloqueia cupom com mensagem amigável "Você já faz parte da família!". Popup mostra mensagem por 15 segundos.

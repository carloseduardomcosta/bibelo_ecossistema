  ...
  function showPopup(config, visitorId) {
    ...
    document.getElementById('bibelo-popup-form').onsubmit = function(e) {
      ...
      .then(function(data) {
        ...
        var vipLink = 'https://boasvindas.papelariabibelo.com.br/api/links/go/grupo-vip?utm_source=popup&utm_medium=web&utm_campaign=' + encodeURIComponent(config.id) + '&utm_content=cta_grupo_vip';

  ...
  <div style="background:#fff;border-radius:20px;padding:0;max-width:440px;width:90%;text-align:center;box-shadow:0 20px 60px rgba(254,104,196,0.2);overflow:hidden;">
    ...
    <div style="padding:30px 28px 24px;">
      ...
      ${isClube ? `<div style="margin-top:16px;">
        <a href="https://boasvindas.papelariabibelo.com.br/api/links/go/grupo-vip?utm_source=email&amp;utm_medium=flow&amp;utm_campaign=confirmacao&amp;utm_content=cta_grupo_vip" style="display:inline-block;background:#25D366;color:#fff;padding:12px 32px;border-radius:30px;text-decoration:none;font-weight:600;font-size:14px;font-family:Jost,sans-serif;">Entrar no Clube VIP WhatsApp 💬</a>
      </div>` : ""}
    </div>

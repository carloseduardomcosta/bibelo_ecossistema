...
import { evolutionWebhookRouter } from "./integrations/evolution/webhook";
import { mpModulosWebhookRouter }  from "./integrations/mp-modulos/webhook";
import { wahaWebhookRouter }       from "./integrations/whatsapp/webhook";
...
app.use("/api/webhooks/mp-modulos", mpModulosWebhookRouter);

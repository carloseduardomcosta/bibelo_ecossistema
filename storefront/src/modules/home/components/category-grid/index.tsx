...
const CATEGORY_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  "Canetas":      { bg: "bg-bibelo-rosa",    text: "text-bibelo-pink",  border: "border-bibelo-rosa" },
  "Cadernos":     { bg: "bg-bibelo-amarelo", text: "text-bibelo-dark",  border: "border-bibelo-amarelo" },
  "Agendas":      { bg: "bg-bibelo-rosa",    text: "text-bibelo-pink",  border: "border-bibelo-rosa" },
  ...
  "Estojos":      { bg: "bg-bibelo-amarelo", text: "text-bibelo-dark",  border: "border-bibelo-amarelo" },
  "Marca-texto":  { bg: "bg-bibelo-rosa",    text: "text-bibelo-pink",  border: "border-bibelo-rosa" },
  "Kits":         { bg: "bg-bibelo-amarelo", text: "text-bibelo-dark",  border: "border-bibelo-amarelo" },
}

const HIGHLIGHT_CATEGORIES = [
  "Canetas", "Cadernos", "Agendas", "Lápis de Cor",
  "Post-it", "Estojos", "Marca-texto", "Kits",
]

...
const MegaMenu = ({ categories, collections }: MegaMenuProps) => {
  ...
  return (
    <Popover className="hidden small:flex items-center h-full">
      {({ close }) => (
        <>
          <PopoverButton className="h-full flex items-center gap-x-1 text-sm font-medium text-bibelo-dark hover:text-bibelo-pink transition-colors outline-none">
            Categorias
          ...
          >
            <PopoverPanel className="absolute left-0 right-0 top-full z-50 bg-white border-t border-bibelo-rosa shadow-lg">

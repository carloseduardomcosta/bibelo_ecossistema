        ...
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Seu pedido chegará em 3 a 7 dias úteis no endereço de sua escolha,
              com todo o carinho da Bibelô.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Não ficou satisfeita? Sem problemas — fazemos a troca do seu
              produto de forma rápida e sem burocracia.
            </p>
          </div>
        </div>
        <div className="flex items-start gap-x-2">
          ...
          <div>
            ...
            <p className="max-w-sm">
              Basta devolver o produto e faremos o reembolso. Sem perguntas
              — fazemos o possível para que sua devolução seja tranquila.
            </p>
          </div>
        </div>
      </div>
